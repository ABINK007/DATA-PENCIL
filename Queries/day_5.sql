...
/*inavlid age in employee table (rule in any company min age:-18 and max age:-65)
 for any company we can not fill anyone's age randomly these should validate through client only..
 */
select *
from clean_employees
where age < 18or age > 65 --For inavlid salary

select *
from clean_Salaries
where salary < 0;
--For rating (0 to 5 rating in employee table)
select *
from clean_performance
where ratting_2022 < 0
    or ratting_2022 > 5;
select *
from clean_performance
where rating_2023 < 0
